...
# Blue Alliance API key (set via environment variable or here)
TBA_AUTH_KEY = os.environ.get("TBA_AUTH_KEY", "dL3PT5VtlP09jaKzNuPJvZAZlNLcabjVx9rDi8uS9kynOFzYeIADlQXNimAEI2W2")
